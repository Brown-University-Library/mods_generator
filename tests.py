...
class TestDataHandler(unittest.TestCase):
    ...
    def test_xls(self):
        ...
        self.assertTrue(isinstance(mods_records[0].field_data()[0]['xml_path'], unicode))
        self.assertTrue(isinstance(mods_records[0].field_data()[0]['data'], unicode))
        self.assertEqual(mods_records[0].field_data()[0]['xml_path'], u'<mods:identifier type="local" displayLabel="Originăl noé.">')
    ...
    def test_csv_dwc(self):
        ...
        self.assertEqual(xml_records[0].field_data()[2]['xml_path'], u'<dwc:specificEpithet>')
        self.assertEqual(xml_records[0].field_data()[2]['data'], u'species')
        ...
        self.assertEqual(xml_records[0].field_data()[5]['xml_path'], u'<dwc:scientificNameAuthorship>')
        self.assertEqual(xml_records[0].field_data()[5]['data'], u'Variety Author')
        self.assertEqual(xml_records[0].field_data()[6]['xml_path'], u'<dwc:acceptedNameUsage>')
        self.assertEqual(xml_records[0].field_data()[6]['data'], u'Genus species var. variety Variety Author')
        self.assertEqual(xml_records[1].field_data()[2]['xml_path'], u'<dwc:specificEpithet>')
        self.assertEqual(xml_records[1].field_data()[2]['data'], u'species2')
        self.assertEqual(xml_records[1].field_data()[3]['xml_path'], u'<dwc:infraspecificEpithet>')
        self.assertEqual(xml_records[1].field_data()[3]['data'], u'subspecies')
        self.assertEqual(xml_records[1].field_data()[4]['xml_path'], u'<dwc:taxonRank>')
        self.assertEqual(xml_records[1].field_data()[4]['data'], u'subspecies')
        self.assertEqual(xml_records[1].field_data()[6]['xml_path'], u'<dwc:acceptedNameUsage>')
        self.assertEqual(xml_records[1].field_data()[6]['data'], u'Genus2 species2 subsp. subspecies Subspecies Author')
        self.assertEqual(xml_records[2].field_data()[2]['xml_path'], u'<dwc:specificEpithet>')
        self.assertEqual(xml_records[2].field_data()[2]['data'], u'species3')
        self.assertEqual(xml_records[2].field_data()[3]['xml_path'], u'<dwc:scientificNameAuthorship>')
        self.assertEqual(xml_records[2].field_data()[3]['data'], u'Species3 Author')
        self.assertEqual(xml_records[2].field_data()[4]['xml_path'], u'<dwc:acceptedNameUsage>')
        self.assertEqual(xml_records[2].field_data()[4]['data'], u'Genus3 species3 Species3 Author')
